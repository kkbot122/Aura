...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white" style={{ fontFamily: 'var(--font-playfair)' }}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-dm-serif">
              We're on a mission to democratize great design and help every
              business build a brand they're proud of.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 font-dm-serif">
                In a world where first impressions matter more than ever, we
                believe every business deserves access to professional
                branding—regardless of their budget or design experience.
              </p>
              <p className="text-lg text-gray-600 mb-8 font-dm-serif">
                Aura+ was born from the frustration of seeing great ideas
                struggle because they couldn't afford expensive design agencies.
                We're combining cutting-edge AI with human-centered design to
                make professional branding accessible to all.
              </p>
              <div className="flex items-center space-x-4">
              ...
              {[1, 2, 3, 4].map((item) => (
                ...
                >
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-800 font-notable mb-1">
                      A+
                    </div>
                    <div className="text-xs text-gray-600 font-dm-serif">
                      Design
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto font-dm-serif">
              Passionate designers, developers, and AI experts working together
              to revolutionize brand creation.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 font-notable">
                  {member.name}
                </h3>
                <div className="text-emerald-600 font-dm-serif font-medium mb-4">
                  {member.role}
                </div>
                ...
                <div className="space-y-2">
                  {member.expertise.map((skill, skillIndex) => (
                    <span
                      key={skillIndex}
                      className="inline-block bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm font-dm-serif mr-2 mb-2"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            {[
              {
                ...
                title: "Innovation",
                description:
                  "We constantly push the boundaries of what AI can achieve in design, always exploring new ways to create better results.",
              },
              {
                icon: "🎯",
                title: "Accessibility",
                description:
                  "Great design should be available to everyone, regardless of budget or technical skills.",
              },
              {
                icon: "❤️",
                title: "Quality",
                description:
                  "We never compromise on quality. Every logo we help create meets professional standards.",
              },
              {
                icon: "🤝",
                title: "Collaboration",
                description:
                  "We believe the best results come from combining AI capabilities with human creativity and feedback.",
              },
              {
                icon: "🌱",
                title: "Growth",
                description:
                  "We’re committed to helping businesses grow by providing tools that scale with their needs.",
              },
              {
                icon: "⚡",
                title: "Speed",
                description:
                  "In today’s fast-paced world, we deliver professional results in minutes, not weeks.",
              },
            ].map((value, index) => (
              <div key={index} className="text-center p-6">
                <div className="text-4xl mb-4">{value.icon}</div>
                <h3 className="text-xl font-bold text-gray-900 mb-4 font-notable">
                  {value.title}
                </h3>
            ...
            {[
              {
                ...
                title: "The Beginning",
                description:
                  "Founded with a vision to make professional design accessible to all businesses.",
              },
              {
                year: "2023",
                title: "AI Integration",
                description:
                  "Integrated advanced machine learning models for intelligent logo generation.",
              },
              {
                year: "2024",
                title: "Global Launch",
                description:
                  "Expanded to serve customers in over 120 countries worldwide.",
              },
              {
                year: "Future",
                title: "What's Next",
                description:
                  "Developing full brand identity suites and advanced customization tools.",
              },
            ].map((milestone, index) => (
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 to-gray-800">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 font-dm-serif max-w-2xl mx-auto">
            Be part of the movement to democratize great design. Create your
            first logo today or reach out to learn more about our vision.
          </p>
