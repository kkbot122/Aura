        ...
        <div className="bg-white rounded-3xl shadow-lg border border-gray-200 p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-gray-500 font-dm-serif">Or sign up with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailSignUp} className="space-y-4">
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-2 font-dm-serif">
                Email
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-gray-700 mb-2 font-dm-serif">
                Password
              </label>
              <input
                id="password"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-emerald-500 hover:bg-emerald-600 text-gray-900 py-3 px-4 rounded-xl font-dm-serif font-semibold transition-colors disabled:opacity-50"
            >
          ...
          <div className="text-center mt-6">
            <p className="text-gray-600 font-dm-serif">
              ...
              <a href="/auth/signin" className="text-emerald-600 hover:text-emerald-700 font-medium">
                Sign in
              </a>
            </p>
          </div>
